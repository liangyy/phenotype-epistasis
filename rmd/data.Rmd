...
```{r, echo=FALSE}
data.inter.crp <- genDataLine(id = c(id.counter), phenotype = c('C reactive protein'), num.of.traits = c(1), sample.size = c(9961), num.of.variants = c(2.4e7), heritability.mean = c(0.16), ancestry = c('european'))
id.counter <- id.counter + 1
