...
library(kableExtra)
library(knitr)
data <- read.csv('../external-data/10.1016.j.cell.2016.10.042-mmc1.csv')#rmd/external-data/10.1016.j.cell.2016.10.042-mmc1.csv')
kable(data, 'html') %>%
  kable_styling() %>%
...
The phenotype information is [here](https://github.com/liangyy/phenotype-epistasis/blob/master/external-data/ncomms11122-s1-table-s1.pdf) (Table S1)
...
The phenotype information is [here](https://github.com/liangyy/phenotype-epistasis/blob/master/external-data/ng.3736-S1-table-s2.pdf) (Table S2)
