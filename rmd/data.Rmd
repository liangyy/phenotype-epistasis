...
The sample information is [here](https://github.com/liangyy/phenotype-epistasis/blob/master/external-data/ng.2383-S1-table-s1.pdf) (Table S1)
...
```{r}
data <- read.csv('../external-data/ng.3760-S2-table-s1.csv')
kable(data, 'html') %>%
  kable_styling() %>%
  scroll_box(width = '1000px', height = '500px')
```