...
```
$ plink --bfile merged_data_QC --logistic --out log_assoc_merged_data_QC
$ Rscript extractDirection.R --input log_assoc.merged_data_QC.logistic --output direction.merge_data_QC.txt.gz
```
...
$ Rscript computeDirection.R --input merged_data_QC_YI.txt.gz --output directon.merged_data_QC_YI.txt.gz
```
...
```
# additive model
$ plink --bfile merged_data_QC --logistic --covar <(zcat < merged_data_QC_YI.txt.gz) --interaction --out interaction_add.merged_data_QC_YI
...
$ plink --bfile merged_data_QC --logistic --covar <(zcat < merged_data_QC_YI.txt.gz) --interaction --dominant --out interaction_dom.merged_data_QC_YI 
$ plink --bfile merged_data_QC --logistic --covar <(zcat < merged_data_QC_YI.txt.gz) --interaction --recessive --out interaction_rec.merged_data_QC_YI 
```