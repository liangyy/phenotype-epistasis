---
title: "Epistasis - Coronary heart disease x HDL"
...
```{r}
ytxt <- read.table('../output-direction_XT_YI/MAGNETIC_HDL.C__wtccc_cad__wtccc_ctrl/xt.assoc.logistic', header = T)
ytyi <- read.table('../output-direction_XT_YI/MAGNETIC_HDL.C__wtccc_cad__wtccc_ctrl/yi.logistic.assoc', header = T)
...
```{r}
interaction <- read.table('../output-run_step2/MAGNETIC_HDL.C__wtccc_cad__wtccc_ctrl/interaction.func_subset_LDpred_p1.0000e-04.assoc.logistic', header = T)
```
